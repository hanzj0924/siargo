...
public abstract class BaseCodeGen<M extends BaseCodeGen<M>> extends JBoltBaseModel<M>{
    ...
    /**headbox是否高度自动auto*/
    public static final String IS_HEADBOX_HEIGHT_AUTO = "is_headbox_height_auto";
    /**
     * 排序操作列操作哪个字段
     */
    public static final String TABLE_OPT_SORT_COLUMN = "table_opt_sort_column";
	/**
	 * 主键ID
	 */
     ...
     * headbox区域高度是否auto
     */
    public M setIsHeadboxHeightAuto(java.lang.Boolean isHeadboxHeightAuto) {
        set("is_headbox_height_auto", isHeadboxHeightAuto);
        return (M)this;
    }
     ...
     * headbox区域高度是否auto
     */
    @JBoltField(name="isHeadboxHeightAuto" ,columnName="is_headbox_height_auto",type="Boolean", remark="headbox区域高度是否auto", required=true, maxLength=1, fixed=0, order=156)
    public java.lang.Boolean getIsHeadboxHeightAuto() {
        return getBoolean("is_headbox_height_auto");
    }

    /**
     * footbox区域高度是否auto
     */
    public M setIsFootboxHeightAuto(java.lang.Boolean isFootboxHeightAuto) {
        set("is_footbox_height_auto", isFootboxHeightAuto);
        return (M)this;
    }
     ...
     * footbox区域高度是否auto
     */
    @JBoltField(name="isFootboxHeightAuto" ,columnName="is_footbox_height_auto",type="Boolean", remark="footbox区域高度是否auto", required=true, maxLength=1, fixed=0, order=156)
    public java.lang.Boolean getIsFootboxHeightAuto() {
        return getBoolean("is_footbox_height_auto");
    }
     ...
     * 排序操作列操作哪个字段
     */
    public M setTableOptSortColumn(java.lang.String tableOptSortColumn) {
        set("table_opt_sort_column", tableOptSortColumn);
        return (M)this;
    }
     ...
     * 排序操作列操作哪个字段
     */
    @JBoltField(name="tableOptSortColumn" ,columnName="table_opt_sort_column",type="String", remark="排序操作列操作哪个字段", required=false, maxLength=60, fixed=0, order=163)
    public java.lang.String getTableOptSortColumn() {
        return getStr("table_opt_sort_column");
    }
