...
public abstract class BaseCodeGenModelAttr<M extends BaseCodeGenModelAttr<M>> extends JBoltBaseModel<M>{
	...
	/** 是否模糊查询*/
    public static final String IS_FUZZY_QUERY = "is_fuzzy_query";
	/** 模糊查询方式*/
	public static final String FUZZY_QUERY_TYPE = "fuzzy_query_type";
	/** 表单组件的帮助信息*/
	public static final String FORM_TIPS = "form_tips";
	/**表单组件帮助信息的颜色*/
	public static final String FORM_TIPS_COLOR = "form_tips_color";
	 ...
	 * 是否模糊查询
	 */
	public M setIsFuzzyQuery(java.lang.Boolean isFuzzyQuery) {
		set("is_fuzzy_query", isFuzzyQuery);
		return (M)this;
	}
	 ...
	 * 是否模糊查询
	 */
	@JBoltField(name="isFuzzyQuery" ,columnName="is_fuzzy_query",type="Boolean", remark="是否模糊查询", required=true, maxLength=1, fixed=0, order=76)
	public java.lang.Boolean getIsFuzzyQuery() {
		return getBoolean("is_fuzzy_query");
	}

	/**
	 * 模糊查询方式
	 */
	public M setFuzzyQueryType(java.lang.String fuzzyQueryType) {
		set("fuzzy_query_type", fuzzyQueryType);
		return (M)this;
	}
	 ...
	 * 模糊查询方式
	 */
	@JBoltField(name="fuzzyQueryType" ,columnName="fuzzy_query_type",type="String", remark="模糊查询方式", required=true, maxLength=20, fixed=0, order=77)
	public java.lang.String getFuzzyQueryType() {
		return getStr("fuzzy_query_type");
	}

	/**
	 * Form表单组件的帮助信息
	 */
	public M setFormTips(java.lang.String formTips) {
		set("form_tips", formTips);
		return (M)this;
	}
	 ...
	 * Form表单组件的帮助信息
	 */
	@JBoltField(name="formTips" ,columnName="form_tips",type="String", remark="Form表单组件的帮助信息", required=false, maxLength=255, fixed=0, order=78)
	public java.lang.String getFormTips() {
		return getStr("form_tips");
	}

	/**
	 * Form表单组件的帮助信息的颜色
	 */
	public M setFormTipsColor(java.lang.String formTipsColor) {
		set("form_tips_color", formTipsColor);
		return (M)this;
	}
	 ...
	 * Form表单组件的帮助信息的颜色
	 */
	@JBoltField(name="formTipsColor" ,columnName="form_tips_color",type="String", remark="Form表单组件的帮助信息的颜色", required=false, maxLength=40, fixed=0, order=79)
	public java.lang.String getFormTipsColor() {
		return getStr("form_tips_color");
	}

	/**
	 * 最小值
	 */
	public M setDataMin(java.math.BigDecimal dataMin) {
	 ...
	 * 最小值
	 */
	@JBoltField(name="dataMin" ,columnName="data_min",type="BigDecimal", remark="最小值", required=false, maxLength=10, fixed=2, order=80)
	public java.math.BigDecimal getDataMin() {
		return getBigDecimal("data_min");
	}

	/**
	 * 最大值
	 */
	public M setDataMax(java.math.BigDecimal dataMax) {
		set("data_max", dataMax);
		return (M)this;
	}
	 ...
	 * 最大值
	 */
	@JBoltField(name="dataMax" ,columnName="data_max",type="BigDecimal", remark="最大值", required=false, maxLength=10, fixed=2, order=81)
	public java.math.BigDecimal getDataMax() {
		return getBigDecimal("data_max");
	}

	/**
	 * 步长值
	 */
	public M setDataStep(java.math.BigDecimal dataStep) {
		set("data_step", dataStep);
		return (M)this;
	}
	 ...
	 * 步值
	 */
	@JBoltField(name="dataStep" ,columnName="data_step",type="BigDecimal", remark="步长值", required=false, maxLength=10, fixed=2, order=82)
	public java.math.BigDecimal getDataStep() {
		return getBigDecimal("data_step");
	}
	 ...
	 * 后缀Html
	 */
	public M setIgAppendHtml(java.lang.String igAppendHtml) {
		set("ig_append_html", igAppendHtml);
		return (M)this;
	}
	 ...
	 * 后缀Html
	 */
	@JBoltField(name="igAppendHtml" ,columnName="ig_append_html",type="String", remark="后缀Html", required=false, maxLength=1000, fixed=0, order=83)
	public java.lang.String getIgAppendHtml() {
		return getStr("ig_append_html");
	}

	/**
	 * 前缀Html
	 */
	public M setIgPrependHtml(java.lang.String igPrependHtml) {
		set("ig_prepend_html", igPrependHtml);
		return (M)this;
	}
	 ...
	 * 前缀Html
	 */
	@JBoltField(name="igPrependHtml" ,columnName="ig_prepend_html",type="String", remark="前缀Html", required=false, maxLength=1000, fixed=0, order=83)
	public java.lang.String getIgPrependHtml() {
		return getStr("ig_prepend_html");
	}
