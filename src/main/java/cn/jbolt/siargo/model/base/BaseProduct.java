...
3大流量
	 ...
	 * 送检数量 (Quantity Submitted for Inspection)
	 */
	public M setQsi(java.lang.Integer qsi) {
		set("qsi", qsi);
		return (M)this;
	}
	 ...
	 * 检验数量 (Quantity Inspected)
	 */
	public M setQi(java.lang.Integer qi) {
		set("qi", qi);
		return (M)this;
	}
...
5全部合格
	 ...
	 * 精度合格检验人
	 */
	public M setAccqUid(java.lang.Long accqUid) {
	 ...
	 * 功能合格检验人
	 */
	public M setFunqUid(java.lang.Long funqUid) {
	 ...
	 * 外观合格检验人
	 */
	public M setAppqUid(java.lang.Long appqUid) {
	 ...
	 * 外观合格检验人
	 */
	@JBoltField(name="appqUid" ,columnName="appq_uid",type="Long", remark="外观合格检验人", required=false, maxLength=19, fixed=0, order=19)
	@JSONField(serializeUsing= ToStringSerializer.class)
	 ...
	 * 最终审核人
	 */
	public M setAllqUid(java.lang.Long allqUid) {
	 ...
	 * 最终审核人
	 */
	@JBoltField(name="allqUid" ,columnName="allq_uid",type="Long", remark="最终审核人", required=false, maxLength=19, fixed=0, order=20)
	@JSONField(serializeUsing= ToStringSerializer.class)
	...
	@JBoltField(name="pdfver" ,columnName="pdfver",type="String", remark="PDFVER", required=false, maxLength=10, fixed=0, order=22)
	 ...
	 * 整机最大电流 8v(Complete Unit Current)
	 */
	@JBoltField(name="cuc" ,columnName="cuc",type="Double", remark="整机最大电流 8v(Complete Unit Current)", required=false, maxLength=4, fixed=2, order=23)
	 ...
	 * 整机电流12v
	 */
	@JBoltField(name="cucmin" ,columnName="cucmin",type="Double", remark="整机电流12v", required=false, maxLength=4, fixed=2, order=25)
	 ...
	 * 脉冲电压(Pulse Voltage)
	 */
	@JBoltField(name="pv" ,columnName="pv",type="Double", remark="脉冲电压(Pulse Voltage)", required=false, maxLength=5, fixed=3, order=26)
	 ...
	 * 热头电压(Thermal Head Voltage)
	 */
	@JBoltField(name="thv" ,columnName="thv",type="Integer", remark="热头电压(Thermal Head Voltage)", required=false, maxLength=10, fixed=0, order=27)
	 ...
	 * 零点内码(Zero Point)
	 */
	@JBoltField(name="zp" ,columnName="zp",type="Integer", remark="零点内码(Zero Point)", required=false, maxLength=10, fixed=0, order=28)
	 ...
	 * 本地地址(Local Address)
	 */
	@JBoltField(name="la" ,columnName="la",type="Integer", remark="本地地址(Local Address)", required=false, maxLength=10, fixed=0, order=31)
	 ...
	 * 删除原因
	 */
	public M setDeleteDes(java.lang.String deleteDes) {
		set("delete_des", deleteDes);
		return (M)this;
	}
	 ...
	 * 删除原因
	 */
	@JBoltField(name="deleteDes" ,columnName="delete_des",type="String", remark="删除原因", required=false, maxLength=255, fixed=0, order=32)
