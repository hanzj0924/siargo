...
6成品检漏*/
    ...
    /**成品检漏时间*/
    public static final String LT_TIME = "lt_time";
    /**成品检漏状态*/
...
6成品检漏
	 ...
	 * 驳回历史总次数（冗余字段，驳回时+1，简化列表查询）
	 */
	public M setRejectCount(java.lang.Integer rejectCount) {
	 ...
	 * 成品检漏检验人（Leak Test for Finished Products）
	 */
	public M setLtUid(java.lang.Long ltUid) {
		set("lt_uid", ltUid);
		return (M)this;
	}
	 ...
	 * 成品检漏时间
	 */
	public M setLtTime(java.util.Date ltTime) {
		set("lt_time", ltTime);
		return (M)this;
	}
	 ...
	 * 成品检漏状态
	 */
	public M setLtStatus(java.lang.Integer ltStatus) {
		set("lt_status", ltStatus);
		return (M)this;
	}
